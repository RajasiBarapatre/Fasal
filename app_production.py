...
try:
    if DISEASE_MODEL_TYPE == "huggingface":
        ...
        DISEASE_MODEL = pipeline(
            ...
            model="Kaludi/plant-disease-classification-vit"  # Accurate ViT model for plant diseases
        )
...
def detect_disease_real(image):
    ...
    try:
        if DISEASE_MODEL is not None:
            ...
            # If it's a specific plant disease, generalize for wheat
            # Map common plant diseases to wheat-relevant names
            disease_mapping = {
                "healthy": "Healthy Crop",
                "leaf spot": "Leaf Spot",
                "rust": "Rust Disease",
                "blight": "Leaf Blight",
                "septoria": "Septoria Blight",
...
with st.sidebar:
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); 
        ...
        <div style="display: flex; align-items: center; margin-bottom: 15px;">
            ...
            <div>
                ...
                <div style="font-size: 14px; opacity: 0.9;">Tomato Farmer</div>
            </div>
        </div>
    ...
    st.caption("Current tomato selling price in your region")
    market_price = st.number_input(
        ...
        value=25, 
        step=1,
        help="Price you'll get when selling tomatoes. Average: ₹20-30/kg"
    )
